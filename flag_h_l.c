...
{
	if (!valid_flag_long(z) && !valid_flag_long_long(z) &&  valid_flag_short(z) && list->c == 'd')
		flag_string(res, i, ft_lltoa((short int)list->f), z);
	else if (!valid_flag_long(z) && !valid_flag_long_long(z) && valid_flag_short_short(z) && list->c == 'd')
...
{
	if (!valid_flag_long(z) && !valid_flag_long_long(z) && valid_flag_short(z) && list->c == 'u')
		flag_u_string(res, i, ft_lltoa((unsigned short int)list->f), z);
	else if (!valid_flag_long(z) && !valid_flag_long_long(z) && valid_flag_short_short(z) && list->c == 'u')
